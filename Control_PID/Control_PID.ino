...
// Parametros de configuracion del controlador PID
double kp = 1.05; // Ganancia proporcional
...
double error; // Error de seguimiento de trayectoria en instante actual
double error_ant = 0; // Error de seguimiento de trayectoria en instante anterior
double integral = 0; // Integral del error
double derivada = 0; // Derivada del error
...
void loop(){
    ...
    if(millis()-t0 >= Ts*1000){
        ...
        integral = integral + Ts*((error + error_ant)/2);
